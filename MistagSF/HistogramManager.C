...
void HistogramManager::WriteHistogram(TH1* anhisto)
{
...
void HistogramManager::SaveHistogram(TH1* hist1, const Char_t* title , const Char_t* option , 
...
//  pad1->cd();
  ...
  if ( strcmp(option , "COLZ") == 0 ) c1->Draw("SURF");
